...
// * by cameyo 2013
// *
// * A board for the game of GO, go-moku, ecc.
// *
...
//  }
  ...
  if (showInfo)
  {
    ...
    fill(240);
    textFont(infoFont);
    text("GO by cameyo", width/2, height/2-80);
    text("The game of GO, go-moku, ecc.", width/2, height/2-58);        
    textAlign(LEFT);

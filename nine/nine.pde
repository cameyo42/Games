...
// * by cameyo 2013
// *
// * Gameboard for nine men morris, shax, ecc.
// *
...
void draw()
{
  ...
  if (showInfo)
  {
    ...
    fill(240);
    textFont(infoFont);
    text("NINE MEN'S MORRIS by cameyo", width/2, height/2-80);
    text("To play Nine Men Morris, Shax, ecc.", width/2, height/2-58);        
    textAlign(LEFT);

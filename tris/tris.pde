...
//    }
  ...
  if (showInfo)
  {
    ...
    fill(240);
    textFont(infoFont);
    text("TIC-TAC-TOE by cameyo", width/2, height/2-80);
    text("The game of Tic-Tac-Toe, Tris.", width/2, height/2-58);        
    textAlign(LEFT);
    text("Click to select a piece and...", width/2-100, height/2-36);
    text("...click to release (autocenter).", width/2-100, height/2-22);
...
void changeAppIcon()
{
  ...
  icon.rect(3, 3, 10, 10);
  icon.line(6, 3, 6, 12);
  icon.line(10, 3, 10, 12);  
  icon.line(3, 6, 12, 6);
  icon.line(3, 10, 12, 10);  
  icon.endDraw();
  // set icon
